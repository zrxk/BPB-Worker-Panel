			...
			<form id="configForm">
				...
				<div class="form-control" style="margin-bottom: 20px;">			
                    <div class="routing">
                        ...
                        <label for="block-ads">过滤广告</label>
                    </div>
                    <div class="routing">
                    ...
                    <div class="routing">
                        ...
                        <label for="block-porn">拦截色情</label>
					</div>
                    <div class="routing">
                ...
                <h2>清理 IP ⚙️</h2>
				<div class="form-control">
					<label for="cleanIPs">✨ 清理 IP</label>
			...
			<div class="table-container">
				<table id="normal-configs-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('sing-box://import-remote-profile?url=https://${hostName}/sub/${userID}?app=sfa#BPB-Normal', '常规订阅')" style="margin-bottom: 8px;">
                                二 维 码&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
			...
			<div class="table-container">
                <table id="frag-sub-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button onclick="openQR('https://${hostName}/fragsub/${userID}#BPB Fragment', '订阅链接')" style="margin-bottom: 8px;">
                                二 维 码&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}#BPB-Warp', 'Warp 订阅')" style="margin-bottom: 8px;">
                                二 维 码&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
